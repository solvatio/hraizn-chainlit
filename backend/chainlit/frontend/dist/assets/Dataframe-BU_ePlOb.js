    ...
    let u = {
      ...
      getValue: (s) => {
        ...
        if (a != null && a.accessorFn)
          return (
            (u._valuesCache[s] = a.accessorFn(u.original, t)), u._valuesCache[s]
          );
      },
      getUniqueValues: (s) => {
    ...
    createTable: (e) => {
      (e.setRowSelection = (o) =>
        ...
        (e.getIsAllRowsSelected = () => {
          ...
          return (
            t && o.some((i) => i.getCanSelect() && !n[i.id]) && (t = !1), t
          );
        }),
...
function _n(e) {
  ...
  return (
    e.rows.forEach(n), { rows: o, flatRows: e.flatRows, rowsById: e.rowsById }
  );
}
function Fn(e) {
  return (o) =>
